...
```{r Rubiscosome_Leaf_Fig, fig.width=8, fig.height=8}
...
```{r Spike_Leaf_Fig, fig.width=8, fig.height=8}
...
```{r Heat_Stress_Fig, fig.width=8, fig.height=8}
...
```{r Heat_Stress_Rca_Fig, fig.width=8, fig.height=8}
